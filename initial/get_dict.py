...
parser.add_argument('--kg_name', type=str, required=True,
                        choices=['elementkg', 'elementkg_chebi_replace', 'elementkg_chebi_integrate'],
                        help="Name of the knowledge graph to be used")
args = parser.parse_args()

kg_name = args.kg_name

onto_path = f'{kg_name}/elementkgontology.embeddings.txt'
...
for fg in name:
    ...
    fg2emb[fg] = ele_emb
pickle.dump(fg2emb, open(f'{kg_name}/fg2emb.pkl','wb'))
...
pickle.dump(ele2emb, open(f'{kg_name}/ele2emb.pkl','wb'))
...
pickle.dump(rel2emb, open(f'{kg_name}/rel2emb.pkl','wb'))    
